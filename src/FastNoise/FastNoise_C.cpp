...
void fnGenStridedArray2D( const void* node, float* noiseOut, int count, const float* posArray, int seed, float* outputMinMax )
{
...
void fnGenStridedArray3D( const void* node, float* noiseOut, int count, const float* posArray, int seed, float* outputMinMax )
{
...
void fnGenStridedArray4D( const void* node, float* noiseOut, int count, const float* posArray, int seed, float* outputMinMax )
{
